...
function AdminDashboard() {
  ...
  return (
    ...
    <div className="flex min-h-screen">
      ...
      <section className="flex-1 bg-linear-to-br from-slate-50 via-indigo-50 to-purple-100 transition-all duration-300">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/60 backdrop-blur-lg z-50">
          <div className="bg-white/40 backdrop-blur-xl rounded-3xl shadow-2xl p-10 w-full max-w-md border border-white/30">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-lg font-semibold text-lg text-white bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600 shadow-lg hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 transition-all duration-300"
              >
                Sign In
              </button>
            </form>
