          ...
          {courses.map((course) => (
            ...
            >
              ...
              <Link to={`/course/${course.course_id}`} className="ml-3">
                <button className="bg-secondary-dark cursor-pointer text-blue-600 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-secondary-dark/80 transition max-md:px-2 max-md:py-1 max-md:text-[10px]">
                  Start Learning
                </button>
              </Link>
            </div>
