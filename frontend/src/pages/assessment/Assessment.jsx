    ...
    <div className="min-h-screen py-8 bg-linear-to-br from-indigo-50 via-white to-purple-50">
      <div className="mx-auto px-6 max-w-7xl">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="bg-linear-to-r from-indigo-600 to-purple-600 text-white px-8 py-3 rounded-2xl shadow-lg">
      ...
      >
        <div className="text-center py-6">
          ...
          <div className="bg-linear-to-r from-indigo-100 to-purple-100 rounded-2xl p-6 mb-4">
