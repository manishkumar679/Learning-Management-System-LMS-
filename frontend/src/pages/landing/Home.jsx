...
function Home() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="relative text-center px-6 h-screen overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-snug mb-6 text-gray-100 animate-fadeInUp">
            ...
            <span className="sm:text-4xl md:text-5xl lg:text-6xl mt-6 text-blue-900">
              SkillMatrix
            </span>
          </h2>
          ...
          <div className="mt-8 flex justify-center gap-4 animate-fadeInUp delay-400">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-yellow-300/80 text-black font-semibold hover:bg-warning transition"
            >
              Explore Courses
            </button>
            <a
        ...
        <div className="grid md:grid-cols-3 gap-8 md:px-24">
          {featureData.map((feature, index) => (
            ...
            >
              <FontAwesomeIcon
                icon={feature.icon}
                className={`text-${feature.color}-500 text-4xl text-yellow-700 mb-4`}
              />
      ...
      <section className="relative px-6 py-24 flex flex-col items-center justify-center text-center bg-purple-500/20">
        <div className="relative z-10 max-w-3xl">
          <p className="font-bold mb-4 text-lg uppercase tracking-wider text-yellow-700">
          ...
          <div className="flex flex-wrap md:gap-6 gap-2 justify-center">
            {[
              ...
              >
                <p className="md:text-4xl md:text-5xl font-extrabold text-blue-400/70">
                  {item.value}
                </p>
