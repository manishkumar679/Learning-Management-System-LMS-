    ...
    <>
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <li className="group bg-white/60 backdrop-blur-xl rounded-3xl p-8 flex items-center gap-6 shadow-lg hover:shadow-2xl border border-white/30 transition-transform duration-300 hover:-translate-y-2">
          <div className="w-20 h-20 flex items-center justify-center rounded-2xl bg-linear-to-br from-blue-500 to-indigo-600 text-white text-4xl shadow-md group-hover:scale-110 transition-transform duration-300">
        ...
        {/* Courses */}
        <li className="group bg-white/60 backdrop-blur-xl rounded-3xl p-8 flex items-center gap-6 shadow-lg hover:shadow-2xl border border-white/30 transition-transform duration-300 hover:-translate-y-2">
          <div className="w-20 h-20 flex items-center justify-center rounded-2xl bg-linear-to-br from-yellow-400 to-orange-500 text-white text-4xl shadow-md group-hover:scale-110 transition-transform duration-300">
        ...
        {/* Enrollments */}
        <li className="group bg-white/60 backdrop-blur-xl rounded-3xl p-8 flex items-center gap-6 shadow-lg hover:shadow-2xl border border-white/30 transition-transform duration-300 hover:-translate-y-2">
          <div className="w-20 h-20 flex items-center justify-center rounded-2xl bg-linear-to-br from-emerald-400 to-green-600 text-white text-4xl shadow-md group-hover:scale-110 transition-transform duration-300">
