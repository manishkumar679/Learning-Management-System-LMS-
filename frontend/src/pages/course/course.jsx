...
const Course = () => {
  ...
  return (
    <div className="min-h-screen py-8 bg-linear-to-br from-indigo-50 via-white to-purple-50">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex-1 mx-6">
            <div className="bg-linear-to-r from-indigo-600 via-purple-600 to-cyan-600 rounded-xl p-3 text-center shadow-lg">
        ...
        <div className="flex gap-4 mt-6">
          <button
            className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-primary/90 transition shadow-lg hover:shadow-xl flex items-center gap-2"
